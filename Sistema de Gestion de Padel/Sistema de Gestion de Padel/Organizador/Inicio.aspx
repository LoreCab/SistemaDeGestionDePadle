<%@ Page Title="" Language="C#" MasterPageFile="~/Organizador/SiteOrganizador.Master" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="Sistema_de_Gestion_de_Padel.Organizador.Inicio" %>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Poder reservar con dias de antelación - 
              Poder formar parte de los equipos de Pádel de la zona- Descuentos y condiciones especiales en los Torneos de Pádel-
              Descuentos y condiciones especiales en venta de material deportivo -
              Posibilidad de reservar pista fija -
              Prioridad en torneos organizados con límite de inscripción -
              Descuentos en distintas empresas colaboradoras.</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 portfolio-item">
          ...
          <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" width="700px" height="200px" src="https://padelstar.es/wp-content/uploads/2019/10/Reglas-de-Padel-Pala-y-Pelotas.jpg" alt=""></a>
            <div class="card-body">
              <h4 class="card-title">
                <a class="mt-4 mb-3 text-primary">Reglamento</a>
              </h4>
