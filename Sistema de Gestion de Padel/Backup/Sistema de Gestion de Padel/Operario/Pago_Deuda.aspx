<%@ Page Title="" Language="C#" MasterPageFile="~/Operario/SiteOperario.Master" AutoEventWireup="true" CodeBehind="Pago_Deuda.aspx.cs" Inherits="Sistema_de_Gestion_de_Padel.Operario.Pago_Deuda" %>
            ...
            <asp:Panel ID="Panel1" runat="server" Visible="False">
                ...
                <div class="controls">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                ...
                                DataKeyNames="PersonasPadId" Width="800px">
                                <Columns>
